...
import re
import os
from xhtml2pdf import pisa  # Nuevo motor: más simple y no falla
from io import BytesIO

# Configuración de la página
st.set_page_config(page_title="Esaú Cars - Invoice Engine", page_icon="🏎️", layout="wide")

# --- LÓGICA DE EXTRACCIÓN (Tu lógica original intacta) ---
...
# --- BOTÓN GENERAR (Aquí es donde está el cambio importante) ---
if st.button("🚀 GENERAR PDF"):
    try:
        ...
        # GENERACIÓN DEL PDF EN MEMORIA (No necesita wkhtmltopdf)
        result = BytesIO()
        pisa_status = pisa.pisaDocument(BytesIO(html_final.encode("UTF-8")), result)
        ...
        if not pisa_status.err:
            ...
            st.error("Hubo un error al procesar el diseño del PDF.")
